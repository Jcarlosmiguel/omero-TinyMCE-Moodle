...
$string['guidestep5body'] = 'Click <strong>Generate embed HTML</strong>, then <strong>Copy to clipboard</strong>. Go to wherever you want the slide to appear - a Label, a Page, a Book chapter, anything with Moodle\'s normal text editor - and paste. Save. Students see the slide and your write-up exactly as you built them.';
