...
$string['defaultheight_desc'] = 'The height a new embed starts at in the authoring tool - a teacher can still override it per embed, and this never affects any embed already generated (the value is fixed into that embed\'s own HTML the moment it\'s inserted, not read live).';
$string['defaultwidth'] = 'Default width';
$string['defaultwidth_desc'] = 'The width a new embed starts at in the authoring tool - a teacher can still override it per embed, and this never affects any embed already generated (the value is fixed into that embed\'s own HTML the moment it\'s inserted, not read live).';
...
$string['viewingoptionsheading_desc'] = 'OMERO.iviewer\'s own on-image controls (individually hideable to reduce clutter for students), plus the size a new embed starts at. All purely defaults - author.php lets a teacher override any of them per embed. The overlay controls are cosmetic only, with no effect on pan/zoom, view-links, or the opening view.';
